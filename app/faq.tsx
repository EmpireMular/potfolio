...
const FAQS = () => {
    return (  
        <div className="mt-10 rounded-tr-md rounded-l-md md:py-10 bg-[#444444]">
            <div className="p-10 md:p-4 md:px-26">
                ...
                <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                        <AccordionTrigger>What is BOD?</AccordionTrigger>
                        <AccordionContent>
                            Bod is a full fledge marketing agency that specializes in branding, web design and digital marketing
                        </AccordionContent>
                    </AccordionItem>
