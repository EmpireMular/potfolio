          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how Bod can help your team work better.
          </div>

          <div className="bg-[#f6f5f4] md:w-full xl:w-4/5 space-y-6 p-4 rounded-2xl my-4 md:flex md:flex-col">
          ...
          {!submitted ? (
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    <FormLabel className="text-sm bg-clip-text text-neutral-400 text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                      How can we help ?
                    </FormLabel>
                    <Select
                      onValueChange={field.onChange}
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Bod for my company">
                            Evaluate Bod for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Bod&apos; sending marketing communications related
                  to bod
                </div>
              </div>
